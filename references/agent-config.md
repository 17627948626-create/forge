...
- **能自动跑的步骤不问人**（调研、初稿、评审、去AI味、排版适配、发布准备）
...
- 去AI味处理（只清理 AI 味和节奏，不覆盖 Writer 的基础文风）
- Layout 渲染适配（render adapter：可做结构扫描、重点锚点与微信安全排版；不得改 thesis / facts / arguments / voice）
